...
def drawboxtosafeline(image_np,p1,p2,Line_Position2,Orientation):
    ...
    if (distance_from_line <= 0) :
             ...
             cv2.putText(image_np, "Kayi Etho Sede ", (posii-70, 60),cv2.FONT_HERSHEY_SIMPLEX, 0.70, (255, 0,0), 2)
			 #sound = os.path.join()
             playsound(r"C:\Users\sukrav\Downloads\HAND DETECT\shredder-machine-hosur\utils\alert.wav")
             cv2.rectangle(image_np, (posii -80,70), (posii+120,30), (255,0,0), thickness=3, lineType=10, shift=0)
